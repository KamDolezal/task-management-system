...
import cz.kdolezal.taskmanagementsystem.implementation.jpa.repository.ProjectJpaRepository;
...
public class ProjectServiceJpaImpl implements ProjectService {
    ...
    public Project mapProjectEntityToProject(ProjectEntity entity) {
        return new Project(
                entity.getId(),
